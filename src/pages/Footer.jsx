    ...
    <div className=" footerb pt-4 sm:py-12 text-white footer pb-5" id='contact'  >
      <Container className=''>
        ...
        <Row className="mt-4 justify-content-center">
          <Col xs="auto">
            <NavLink  to="https://mail.google.com/mail/?view=cm&fs=1&to=awaisahmed4528011@gmail.com&su=Portfolio%20Inquiry&body=Hello,%20I%20am%20interested%20in%20your%20portfolio." target="_blank" rel="noopener noreferrer" className="d-flex justify-content-center align-items-center">
          ...
          <Col xs="auto">
            <NavLink to="https://www.linkedin.com/in/awais-ahmed- 086040264" target="_blank" rel="noopener noreferrer" className="d-flex justify-content-center align-items-center">
              <Image
                className="max-h-12 w-full object-cover transition-transform duration-500 ease-in-out transform hover:scale-125 hover:rotate-6 hover:shadow-lg"
