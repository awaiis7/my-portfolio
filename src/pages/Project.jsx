...
function Project() {
  return (
    <div className="">
      <Navbar expand="lg" id="project" className="navbar-custom pt-5 pb-5">
        <Container className="mt-5 mb-5">
          <Navbar.Brand>
            <Nav.Link as={Link} to="/" className="/project">Projects</Nav.Link>
          </Navbar.Brand>
          ...
          <Nav className="me-auto flex-row">
            <Nav.Link as={Link} to="/Project/html" className="mx-2">HTML/CSS</Nav.Link>
            <Nav.Link as={Link} to="/Project/javascript" className="mx-2">JavaScript</Nav.Link>
            <Nav.Link as={Link} to="/Project/react" className="mx-2">React</Nav.Link>
          </Nav>
        </Container>
      </Navbar>
      <Container className="">
